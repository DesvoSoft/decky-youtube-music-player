import { ButtonItem, DialogButton, Focusable, ToggleField, SliderField } from '@decky/ui';
...
export const PlayerView = () => {
  ...
  const hasStreamError = track?.url === undefined || track?.url === '';
  ...
  return (
    <>
        ...
        <Section>
          <div style={{ padding: '4px 16px' }}>
            ...
            <div style={{
              ...
              fontSize: '11px', color: 'var(--gpSystemLighterGrey)',
              marginTop: '-4px',
            }}>
      ...
      {/* Streaming error */}
      {hasStreamError && track && (
        <Section>
          <div style={{
            padding: '8px 16px', fontSize: '12px', color: '#ff6b6b',
            background: 'rgba(255,107,107,0.1)', borderRadius: '4px',
          }}>
            Failed to load stream for &quot;{track.title}&quot;. Retrying...
          </div>
        </Section>
      )}
